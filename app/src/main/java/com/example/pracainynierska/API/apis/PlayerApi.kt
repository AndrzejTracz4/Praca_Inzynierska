...
class PlayerApi(basePath: String = defaultBasePath, client: OkHttpClient = defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun apiRegisterPost(playerPlayercreatePlayerwrite: PlayerPlayercreatePlayerwrite) : PlayerPlayerreadPlayeritemread {
        val localVarResponse = apiRegisterPostWithHttpInfo(playerPlayercreatePlayerwrite = playerPlayercreatePlayerwrite)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun apiRegisterPostWithHttpInfo(playerPlayercreatePlayerwrite: PlayerPlayercreatePlayerwrite) : ApiResponse<PlayerPlayerreadPlayeritemread?> {
        val localVariableConfig = apiRegisterPostRequestConfig(playerPlayercreatePlayerwrite = playerPlayercreatePlayerwrite)
    ...
    /**
     * To obtain the request config of the operation apiRegisterPost
     *
     * @param playerPlayercreatePlayerwrite The new Player resource
     * @return RequestConfig
     */
    fun apiRegisterPostRequestConfig(playerPlayercreatePlayerwrite: PlayerPlayercreatePlayerwrite) : RequestConfig<PlayerPlayercreatePlayerwrite> {
